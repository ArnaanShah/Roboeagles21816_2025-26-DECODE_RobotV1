...
@Config
@Autonomous(name = "Blue Side 3- Wait 25s, leave near side", group = "Autonomous")

public class BlueSide_3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder leg1 = drive.actionBuilder(initialPose)
                .waitSeconds((22.5))//Ramp up ot and wait 15
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        leg1.build(),
                        //outtake.shootArtifacts(0.245, 4),
                        //leg2.build(),
