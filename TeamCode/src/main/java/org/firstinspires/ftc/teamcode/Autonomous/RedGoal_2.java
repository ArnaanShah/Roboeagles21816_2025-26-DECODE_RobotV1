...
@Config
@Autonomous(name = "Red Goal 2- Shoot loaded, leave near gate", group = "Autonomous")

public class RedGoal_2 extends LinearOpMode {
...
/*
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder leg2 = leg1.endTrajectory().fresh()
                ...
                .strafeToLinearHeading(new Vector2d(-5.5, 20), Math.toRadians(270))
        ...
        Actions.runBlocking(
                new SequentialAction(
                        intake.intakeOn(),
                        outtake.rampUpOuttake(0.4),

                        leg1.build(),
                        outtake.shootArtifacts(0.45, 8),

                        //leg2.build(),
                        //outtake.shootArtifacts(0.1725, 4),
                        //leg3.build(),
