...
@Config
@Autonomous(name = "Red Side 1-OLD", group = "Autonomous")
@Disabled
public class RedSide_1_OLD extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder leg2 = leg1.endTrajectory().fresh()
                ...
                .strafeToSplineHeading(new Vector2d(61, 67.5), Math.toRadians(270), new TranslationalVelConstraint(75))
