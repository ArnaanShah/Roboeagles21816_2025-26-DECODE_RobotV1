...
@Config
@Autonomous(name = "Blue Side 1- Shoot loaded, corner, leave near side", group = "Autonomous")

public class BlueSide_1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        leg1.build(),
                        outtake.shootArtifacts(0.85, 4),
                        leg2.build(),
                        outtake.shootArtifacts(0.825, 4),
                        //leg3.build(),
