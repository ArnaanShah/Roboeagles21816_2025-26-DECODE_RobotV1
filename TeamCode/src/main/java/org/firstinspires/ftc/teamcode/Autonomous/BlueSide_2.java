...
@Config
@Autonomous(name = "Blue Side 2- Wait 15s, Shoot loaded, leave near side", group = "Autonomous")

public class BlueSide_2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder leg1 = drive.actionBuilder(initialPose)
                .waitSeconds((15))//Ramp up ot and wait 15
                //Forward and turn to shoot
                .strafeToLinearHeading(new Vector2d(52, -14.5), Math.toRadians(-160));
        //Shoot 4
        ...
        TrajectoryActionBuilder leg2 = leg1.endTrajectory().fresh()
                ...
                .strafeToLinearHeading(new Vector2d(52, -7.5), Math.toRadians(-160));
                //Shoot 4
        ...
        Actions.runBlocking(
                new SequentialAction(
                        intake.intakeOn(),
                        outtake.rampUpOuttake(0.8),

                        leg1.build(),
                        outtake.shootArtifacts(0.825, 6),
                        //leg2.build(),
                        //outtake.shootArtifacts(0.2425, 4),
                        //leg3.build(),
