...
@Config
@Autonomous(name = "Red Side 2- Wait 15s, Shoot loaded, leave near side", group = "Autonomous")

public class RedSide_2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder leg1 = drive.actionBuilder(initialPose)
                .waitSeconds((15))//Ramp up ot Wait 15s
